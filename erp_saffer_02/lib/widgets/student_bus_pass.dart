...
import 'student_id_card.dart'; // Reusing QrCodePainter for the bus pass as well

class StudentBusPass extends StatelessWidget {
  final BusPassModel passModel;
  const StudentBusPass({super.key, required this.passModel});
          ...
          children: [
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      isValid ? 'VALID BUS PASS' : 'EXPIRED BUS PASS',
            ...
            Expanded(
              child: Padding(
                ...
                child: Column(
                  children: [
                    // Student Photo & Core Details Row
                    Row(
                      children: [
                        // Small Photo Box
                        Container(
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 2),
                              Text(
                                'Class: Year ${passModel.year} / Sec ${passModel.section}',
                                style: const TextStyle(
                                  fontSize: 11,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.black54,
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          const Divider(height: 12),
                          _buildDetailRow('TIME', passModel.pickupTime),
                          const Divider(height: 12),
                          _buildDetailRow(
                            'VALIDITY',
